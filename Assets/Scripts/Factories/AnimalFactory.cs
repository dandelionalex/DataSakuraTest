...
namespace Zoo.Factories
{
    public sealed class AnimalFactory
    {
        ...
        AnimalConfig _animalConfig;
        GameObject CreateGameObject()
        {
            var view = _container.InstantiatePrefab(_animalConfig.prefab); 
        }
    }
}